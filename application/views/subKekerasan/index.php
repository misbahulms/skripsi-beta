    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Halaman Kelola Bentuk Kekerasan</h5>
                <!--end::Page Title-->
                <!--begin::Actions-->
            ...
            <!--end::Info-->
            <!--begin::Toolbar-->
            <a href="<?= site_url('subKekerasan/addSubKekerasan') ?>" class="btn btn-icon" data-toggle="popover"
                    ...
                    <div class="table-responsive">
                        <table class="table table-head-custom table-head-bg table-vertical-center table-borderless"
                            ...
                            <thead>
                                <tr class="text-left">
                                    <th scope="col">No</th>
                                    <th scope="col">Kasus Kekerasan</th>
                                    <th scope="col">Sub Kasus Kekerasan</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div><?= $sub['jenis_kekerasan'];  ?></div>
                                    </td>
                                    <td>
                                        <div><?= $sub['sub_jenis_kekerasan'];  ?></div>
                                    </td>
                                    <td class="py-0 ">
                                        <a href="<?= site_url('subKekerasan/editSubKekerasan/') ?><?= $sub['id_sub_bentuk_kekerasan'] ?>"
                                        ...
                                        <a href="<?= site_url('subKekerasan/delete/') ?><?= $sub['id_sub_bentuk_kekerasan'] ?>"

                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-xl-9">
                                                    ...
                                                    <div class="my-5 step" data-wizard-type="step-content"
                                                        ...
                                                        <h5 class="text-dark font-weight-bold mb-10">Edit Desa
                                                        </h5>
                                                        <!--begin::Group-->
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <select class="form-control" name="nama_kecamatan"
                                                                    ...
                                                                    <?php foreach ($kecamatan as $kp) : ?>
                                                                    <?php if ($kp['nama_kecamatan'] == $desa['nama_kecamatan']) : ?>
                                                                    <option value="<?= $kp['id_kecamatan'] ?>" selected>
                                                                        <?= $kp['nama_kecamatan']  ?>
                                                                    </option>
                                                                    <?php else : ?>
                                                                    <option value="<?= $kp['id_kecamatan'] ?>">
                                                                        <?= $kp['nama_kecamatan']  ?></option>
                                                                    <?php endif; ?>
                                                                    <?php endforeach; ?>
                                                                </select>

                            ...
                            <div class="d-flex align-items-center flex-wrap mr-1">
                                ...
                                <div class="d-flex align-items-baseline flex-wrap mr-5">
                                    ...
                                    <div class="text-right">
                                        <button class="btn btn-primary">haaa</button>
                                    </div>
                                    <!--end::Page Title-->
                                    <!--begin::Breadcrumb-->
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    <div class="symbol-label"
                        style="background-image:url('<?= base_url() ?>assets/media/users/300_21.jpg')">
                    </div>
...
// <?php
    //     $getKecamatan = $this->Kecamatan_model->get_kecamatan();
    //     foreach ($getKecamatan as $kec) {
    //     
    ?>

// var myStyle<?= $kec->id_kecamatan ?> = {
// "color": "<?= $kec->warna_kecamatan ?>",
// "weight": 1,
// "opacity": 1
// };
...
// <?php
    ...
    //             icon: iconByName("' . $kec->warna_kecamatan . '"),
    //             layer: new L.GeoJSON.AJAX(["assets/geojson/' . $kec->geojson_kecamatan . '"], {onEachFeature:popUp, style: 
    //                 myStyle' . $kec->id_kecamatan . ',pointToLayer: featureToMarker}).addTo(map)
    //         }';
    //     }
    //     
    ?>

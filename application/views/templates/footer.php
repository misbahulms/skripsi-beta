    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            ...
            <div class="d-flex flex-column">
                <a href="#"
                    class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"><?= $user['nama'];  ?></a>
                ...
                <div class="navi mt-2">
                    ...
                    <a style="background-color: rgba(50, 150, 69, 0.19); color: #329645;"
                        class="btn btn-lg font-weight-bolder py-2 px-5 tombol-keluar">Sign Out</a>
                </div>
            </div>
        </div>
        <!--end::Header-->

                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="py-5">
                                                    <a
                                                        href="<?= site_url('person/detailkorban/') ?><?= $kbn['id_korban'] ?>"><?= $kbn['nik'];  ?>
                                                    </a>
                                                </td>
                                                <td>
                                                    <div><?= $kbn['nama'];  ?></div>
                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="py-5">
                                                    <a
                                                        href="<?= site_url('person/detailpelaku/') ?><?= $pel['id_pelaku'] ?>"><?= $pel['nik'];  ?>
                                                    </a>
                                                </td>
                                                <td>
                                                    <div><?= $pel['nama'];  ?></div>
                                                ...
                                                <td>
                                                    <div><?= $pel['jenis_kelamin'];  ?></div>
                                                </td>
                                                <td>
                                                    <div><?= $pel['status_perkawinan'];  ?></div>
                                                </td>
                                                <td>
                                                    <div><?= $pel['pekerjaan'];  ?></div>
                                                </td>
                                                <td>
                                                    <div><?= $pel['pendidikan_terakhir'];  ?></div>
                                                </td>
                                            </tr>

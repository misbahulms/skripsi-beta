    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Halaman Edit Pelaku</h5>
                <!--end::Page Title-->
                <!--begin::Actions-->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header">
                            <h3 class="card-title">Edit Pelaku</h3>
                        ...
                        <form class="form" method="post" action="">
                            <div class="card-body">
                                <div class="form-group row">
                                    <input type="hidden" class="form-control" placeholder="" name="id_pelaku"
                                        value="<?= $pelaku['id_pelaku'] ?>">
                                    <input type="hidden" class="form-control" placeholder="" name="id_pengaduan"
                                        value="<?= $pelaku['id_pengaduan'] ?>">
                                    <div class="col-lg-4">
                                        <label>NIK:</label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select class="form-control" name="jenis_kelamin"
                                            ...
                                            <?php if ($jk == $pelaku['jenis_kelamin']) : ?>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        ...
                                        <select class="form-control select2" id="kt_select2_1" name="id_desa">
                                            ...
                                            <?php if ($des['id_desa'] == $pelaku['id_desa']) : ?>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select class="form-control" name="status_perkawinan"
                                            ...
                                            <?php if ($per == $pelaku['status_perkawinan']) : ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select class="form-control" name="pendidikan_terakhir"
                                            ...
                                            <?php if ($pen == $pelaku['pendidikan_terakhir']) : ?>
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 text-lg-right">
                                        <a href="<?= site_url('pengaduan/detail/') ?><?= $pelaku["id_pengaduan"] ?>"

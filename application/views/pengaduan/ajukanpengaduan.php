                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-4">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="korban_kekerasan" placeholder=""
                                            value="<?= $pelaporan_kasus['korban_kekerasan']  ?>" />
                                    </div>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <select class="form-control select2" id="kt_select2_1" name="sub_jenis_kekerasan">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="alamat_kejadian" placeholder=""
                                            value="<?= $pelaporan_kasus['alamat_kejadian']  ?>" />
                                    </div>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="tempat_kejadian" placeholder=""
                                            value="<?= $pelaporan_kasus['tempat_kejadian']  ?>" />
                                    </div>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-4">
                                    ...
                                    <input type="text" class="form-control" name="hubungan_dengan_korban"
                                        value="<?= $pelaporan_kasus['hubungan_dengan_korban']  ?>" placeholder="" />
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder=""
                                            value="<?= $pelaporan_kasus['nama_desa']  ?>, kecamatan <?= $pelaporan_kasus['nama_kecamatan']  ?>"
                                            disabled />
                                        <input type="text" class="form-control" name="id_desa" placeholder=""
                                            value="<?= $pelaporan_kasus['id_desa']  ?>" hidden />
                                    </div>
                                    <?= form_error('id_desa', '<div class="fv-plugins-message-container"><div class="fv-help-block">', '</div></div>') ?>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-lg-4">
                                    ...
                                    <input type="text" class="form-control" name="nama"
                                        value="<?= $pelaporan_kasus['id_pelapor']  ?>" hidden />
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="text" class="form-control" name="alamat_pelapor"
                                        value="<?= $pelaporan_kasus['alamat_pelapor']  ?>" placeholder="" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <textarea type="text" class="form-control" name="kronologis_kejadian"
                                        placeholder=""><?= $pelaporan_kasus['kronologis_kejadian']  ?></textarea>
